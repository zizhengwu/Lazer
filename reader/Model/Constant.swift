...
class Constant {
    ...
    static var endZenTime: NSDate {
        get {
            return NSUserDefaults.standardUserDefaults().objectForKey("endZenTime") as? NSDate ?? NSDate()
        }
    }
    static var startZenTime: NSDate {
        get {
            return NSUserDefaults.standardUserDefaults().objectForKey("startZenTime") as? NSDate ?? NSDate()
        }
    }
    static var firstReadTime: NSDate{
        get {
